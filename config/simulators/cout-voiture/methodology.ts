...
export const coutVoitureMethodology: MethodologyContent = {
  ...
  assumptions: [
    { label: "Décote 1ʳᵉ année (neuf)", value: "20 %", note: "puis 12 %/an — L'Argus" },
    { label: "Décote occasion récente", value: "≈ 11 %/an" },
    { label: "Consommation essence", value: "6,8 L/100 km", note: "diesel 5,3 · hybride 4,5" },
    { label: "Électrique", value: "16 kWh/100 km", note: "ADEME" },
    { label: "Prix carburant", value: "1,90 €/L", note: "électricité 0,22 €/kWh" },
    { label: "Assurance / an", value: "420 à 950 €", note: "tiers → tous risques" },
    { label: "Entretien / an", value: "450 à 800 €", note: "selon motorisation et âge" },
